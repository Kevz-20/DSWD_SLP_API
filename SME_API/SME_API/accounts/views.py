...
def customer_debts(request, customer_id: int):
    ...
    qs = (SalesCredit.objects
          .filter(customer_id=customer_id, account_id=account_id)  # <- keep filter
...
def apply_customer_payment(request, customer_id: int):
    ...
    qs = SalesCredit.objects.filter(customer_id=customer_id, account_id=account_id, amount__gt=0) \
